...
import static com.selenium.context.manager.DriverManager.session;
...
public class ReportGenerate extends TestWatcher
{
    ...
    private ExtentReports createReport()
    {
        ...
        ExtentReports extent = new ExtentReports(String.format(configuration.getTestResultReport(), dateFormat.format(date)), false);
        extent.config().reportName("Optiim Regression Tests");
