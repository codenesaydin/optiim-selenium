...
public class Configuration
{
    ...
    private String testUsernamePassword;
    ...
    public Configuration() throws IOException
    {
        ...
        this.testUsername = configProps.getProperty("test.username");
        this.testUsernamePassword = configProps.getProperty("test.username.password");
    ...
    public String getTestUsernamePassword()
    {
        return testUsernamePassword;
    }

    public void setTestUsernamePassword(String testUsernamePassword)
    {
        this.testUsernamePassword = testUsernamePassword;
    }
}
